...
Release verification covers pure model operations, viewport gesture tests, React panel behavior, the App create-save-undo workflow, Chromium and Firefox export of explicit and parametric series, production image hardening and security scanning.
