...
Release verification covers model operations, diagnostics, internal viewport gestures, renderer-context propagation, creation and save commands, undo/redo compatibility, Chromium and Firefox smoke, exported explicit and parametric series, production image hardening and security scanning.
