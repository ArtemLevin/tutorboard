...
Smoothing remains a render-time concern, so document serialization, collaboration commands, selection geometry, undo and redo continue to use the original captured points.
