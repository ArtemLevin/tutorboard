...
export const defaultAdaptiveTolerancePixels = 0.65;
export const defaultMaximumSegmentPixels = 96;
export const defaultMinimumInitialIntervals = 12;
export const defaultInitialIntervalPixels = 32;
