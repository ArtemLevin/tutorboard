...
> Архивный backlog, составленный для HEAD
> `133958596dec64ad597614acb597b7ae165d9e91` 10.08.2026. Выполненные после
> этой даты пункты здесь намеренно не переписываются. Текущий порядок работ
> определяет `PLAN.md`, а фактический продуктовый статус — `README.md`.
